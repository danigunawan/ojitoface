...
app.get('/', (req, res) => res.redirect('/videoanalisis'))
app.get('/videoanalisis', (req, res) => res.sendFile(path.join(viewsDir, 'videoanalisis.html')))
...
//este sector es mio hay que ponerlo para que reconozca la pagina
